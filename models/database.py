...
load_dotenv()
DB_PATH = os.getenv('DATABASE', './data/tarefa.sqlite3')

def init_db(db_name: str =DB_PATH) -> None:
    with connect(db_name) as conn:
        conn.execute("""
        CREATE TABLE IF NOT EXITS tarefas (
...
class Database:
    ...
    def __init__(self, db_name: str =DB_PATH) -> None:
        ...
        self.executar("""
            CREATE TABLE IF NOR EXISTS obra(id INTEGER PRIMARY KEY AUTOINCREMENT, titulo_obra TEXT NOT NULL, indicacao TEXT)""")
        
    def executar(self, query: str, params: tuple =()) -> list[Any]:
